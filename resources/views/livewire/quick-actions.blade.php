<div class="grid grid-cols-4 gap-4 mb-6">
    ...
    <a href="{{ route('attendances.index') }}" class="flex flex-col items-center gap-2 group">
        ...
        <span class="text-xs font-medium text-gray-600 dark:text-gray-300 text-center leading-tight">{{ __('History') }}</span>
    </a>

    <a href="{{ route('attendances.create') }}" class="flex flex-col items-center gap-2 group">
    ...
    <a href="{{ route('schedule.index') }}" class="flex flex-col items-center gap-2 group">
        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center text-white shadow-lg shadow-violet-500/30 group-hover:scale-105 transition-transform">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
